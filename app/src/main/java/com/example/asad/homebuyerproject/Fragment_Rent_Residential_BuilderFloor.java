...
public class Fragment_Rent_Residential_BuilderFloor extends Fragment {
    ...
    public Fragment_Rent_Residential_BuilderFloor() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_rent_residential_builderflorr, container, false);
        TypeCasting(view);
        ButtonClick();
