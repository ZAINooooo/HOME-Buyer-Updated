...
public class Fragment_Sell_Residential_BuilderFloor extends Fragment {
    ...
    public Fragment_Sell_Residential_BuilderFloor() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_sell_residential_builderflorr, container, false);
        TypeCasting(view);
        ButtonClick();
