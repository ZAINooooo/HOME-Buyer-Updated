...
public class Fragment_Sell_Residential_Plot extends Fragment {
    ...
    private String corner,currentconstruction,societytype,boundarywall;
    private OnFragmentInteractionListener mListener;

    public Fragment_Sell_Residential_Plot() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_sell_residential_plot, container, false);
        ...
        mRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                {
                    corner="NO";
                }else if(checkedId == R.id.anyconstructionyes)
                {
                    currentconstruction="YES";
                }else if(checkedId == R.id.anyconstructionno)
                {
                    currentconstruction="NO";
                ...
                {
                    societytype="NO";
                }else if(checkedId == R.id.boundarywallyes)
                {
                    boundarywall="YES";
                }else if(checkedId == R.id.boundarywallno)
                {
                    boundarywall="YES";
                }
        ...
        GetReady.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isValidArea(mCoveredarea.getText().toString()))
                {
                    ...
                    propertyData.add("FloorAllowed");
                    propertyData.add(FloorsAllowedCounter.toString());
                    propertyData.add("SiteOpened");
                    propertyData.add(NumberSitesCounter.toString());
                    propertyData.add("CornerProperty");
                    propertyData.add(corner);
                    propertyData.add("SocietyType");
                    propertyData.add(societytype);
                    propertyData.add("OngingConstruction");
                    propertyData.add(currentconstruction.toString());
                    propertyData.add("IsBoundarywall");
                    propertyData.add(boundarywall.toString());
