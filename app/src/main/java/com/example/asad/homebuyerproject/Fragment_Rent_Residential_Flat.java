...
public class Fragment_Rent_Residential_Flat extends Fragment {
    ...
    public Fragment_Rent_Residential_Flat() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_rent_residential_flat, container, false);
        TypeCasting(view);
        ButtonClick();
