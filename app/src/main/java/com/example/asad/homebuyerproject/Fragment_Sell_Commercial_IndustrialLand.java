...
public class Fragment_Sell_Commercial_IndustrialLand extends Fragment {
    ...
    private String currentconstruction,corner,hasboundary;
    ...
    public Fragment_Sell_Commercial_IndustrialLand() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_sell_commercial_industrialland, container, false);
        ...
        GetReady.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isValidArea(mCoveredarea.getText().toString()))
                {
                    ...
                    propertyData.add("OngoingConstruction");
                    propertyData.add(currentconstruction);
                    propertyData.add("hasBoundaryWall");
