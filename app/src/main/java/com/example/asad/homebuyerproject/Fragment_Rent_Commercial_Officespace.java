...
public class Fragment_Rent_Commercial_Officespace extends Fragment {
    ...
    public Fragment_Rent_Commercial_Officespace() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_rent_commercial_officespace, container, false);
