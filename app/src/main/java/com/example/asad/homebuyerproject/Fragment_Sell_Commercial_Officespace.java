...
public class Fragment_Sell_Commercial_Officespace extends Fragment {
    ...
    public Fragment_Sell_Commercial_Officespace() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_sell_commercial_officespace, container, false);
