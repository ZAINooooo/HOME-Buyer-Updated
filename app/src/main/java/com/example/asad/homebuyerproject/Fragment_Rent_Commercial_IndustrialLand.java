...
public class Fragment_Rent_Commercial_IndustrialLand extends Fragment {
    ...
    private String corner,currentconstruction,hasboundary;
    private OnFragmentInteractionListener mListener;

    public Fragment_Rent_Commercial_IndustrialLand() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_rent_commercial_industrialland, container, false);
        ...
        GetReady.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    propertyData.add("isUnderconstruction");
                    propertyData.add(currentconstruction);
                    propertyData.add("PropertyCorner");
                    propertyData.add(corner);
                    propertyData.add("hasBoundaryWalls");
                    propertyData.add(hasboundary);
