...
public class Fragment_Rent_Commercial_CommercialLand extends Fragment {
    ...
    public Fragment_Rent_Commercial_CommercialLand() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_rent_commercial_commercialland, container, false);
