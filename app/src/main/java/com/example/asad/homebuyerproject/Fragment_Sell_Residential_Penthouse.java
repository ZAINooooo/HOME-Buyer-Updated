...
public class Fragment_Sell_Residential_Penthouse extends Fragment {
    ...
    public Fragment_Sell_Residential_Penthouse() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_sell_residential_penthouse, container, false);
        TypeCasting(view);
        ButtonClick();
