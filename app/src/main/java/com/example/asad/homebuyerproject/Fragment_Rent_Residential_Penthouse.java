...
public class Fragment_Rent_Residential_Penthouse extends Fragment {
    ...
    public Fragment_Rent_Residential_Penthouse() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_rent_residential_penthouse, container, false);
        TypeCasting(view);
        ButtonClick();
