...
public class Fragment_Rent_Residential_StudioApartment extends Fragment {
    ...
    private TextView mBathrominc, mBathroomdec, mFloorinc, mFloordec, mTotalFloorinc, mTotalFloordec, mBedroomdec, mBedroominc, mBalconyinc, mBalconydec;
    private TextView mValueBathroom, mValueFloor, mTotalFloorValue, mValueBedroom, mValueBalcony;
    private Integer BathroomCounter = 1, FloorCounter = 1, TotalFloorCounter = 1, BedroomCounter = 1, BalconyCounter = 1;


    private OnFragmentInteractionListener mListener;

    public Fragment_Rent_Residential_StudioApartment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_rent_residential_studioapartment, container, false);
        TypeCasting(view);
        ButtonClick();
