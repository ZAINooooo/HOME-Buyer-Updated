...
public class Fragment_Rent_Residential_House extends Fragment {
    ...
    public Fragment_Rent_Residential_House() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_rent_residential_house, container, false);
