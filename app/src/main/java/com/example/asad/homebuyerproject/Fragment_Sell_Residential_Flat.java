...
public class Fragment_Sell_Residential_Flat extends Fragment {
    ...
    public Fragment_Sell_Residential_Flat() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_sell_residential_flat, container, false);
