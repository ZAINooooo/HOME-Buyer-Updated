...
public class Fragment_Sell_Residential_Villa extends Fragment {
    ...
    public Fragment_Sell_Residential_Villa() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_sell_residential_villa, container, false);
        TypeCasting(view);
        ButtonClick();
