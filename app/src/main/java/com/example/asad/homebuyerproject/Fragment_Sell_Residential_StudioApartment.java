...
public class Fragment_Sell_Residential_StudioApartment extends Fragment {
    ...
    public Fragment_Sell_Residential_StudioApartment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_sell_residential_studioapartment, container, false);
        TypeCasting(view);
        ButtonClick();
